...
from src.features import (  # noqa: E402
    ...
    create_features,
    fit_clip_bounds,
    returns_to_percentiles,
)
from src.model import TransformerModel  # noqa: E402
...
def main():
    ...
    # create features
    feat_train = create_features(
        train_btc, train_eth, train_gold, hashrate, train_funding, fear_greed
    )
